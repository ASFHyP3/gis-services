...
parser.add_argument('--raster-filter', default='*_VV.tif')
parser.add_argument('--server-connection-file', default='server_connection.json')
parser.add_argument('--service-name', default='ASF_S1_RTC_VV')
...
raster_function_template = f'Sentinel1_RTC_Power.rft.xml;Sentinel1_RTC_Amplitude.rft.xml;Sentinel1_RTC_dB.rft.xml;Sentinel1_RTC_dB_Stretch.rft.xml'
...
with tempfile.NamedTemporaryFile(suffix='.sddraft') as service_definition_draft:
    ...
    arcpy.CreateImageSDDraft(
        ...
        summary='Radiometric Terrain Corrected (RTC) products generated from Sentinel-1 SAR imagery, '
                ...
                'off the surface away from the sensor. High VV values are commonly driven by surface roughness '
                'and/or high soil moisture.',
    )
