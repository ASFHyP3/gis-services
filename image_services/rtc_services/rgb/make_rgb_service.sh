...
python /home/arcgis/gis-services/image_services/rtc_services/rgb/make_rgb_service.py \
  --server-connection-file /home/arcgis/server_connection.json \
  --working-directory /home/arcgis/gis-services/image_services/rtc_services/rgb/
