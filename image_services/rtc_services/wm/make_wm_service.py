...
parser.add_argument('--raster-filter', default='*_WM.tif')
parser.add_argument('--server-connection-file', default='server_connection.json')
parser.add_argument('--service-name', default='ASF_S1_WM')
...
raster_function_template = f'{args.working_directory}/WatermapExtentBlueOnly.rft.xml;' \
                           f'{args.working_directory}/WatermapExtentWhiteandBlue.rft.xml'
default_raster_function_template = f'{args.working_directory}/WatermapExtentBlueOnly.rft.xml'
...
with tempfile.NamedTemporaryFile(suffix='.sddraft') as service_definition_draft:
    ...
    arcpy.CreateImageSDDraft(
        ...
        summary='Watermap Extent products generated from Sentinel-1 SAR imagery, generated by ASF.',
    )
